...
export interface mjtDisableBit {
  /** entire constraint solver                 */
  mjDSBL_CONSTRAINT: EnumType;
  /** equality constraints                     */
  mjDSBL_EQUALITY: EnumType;
  /** joint and tendon frictionloss constraints */
  mjDSBL_FRICTIONLOSS: EnumType;
  /** joint and tendon limit constraints       */
  mjDSBL_LIMIT: EnumType;
  /** contact constraints                      */
  mjDSBL_CONTACT: EnumType;
  /** passive forces                           */
  mjDSBL_PASSIVE: EnumType;
  /** gravitational forces                     */
  mjDSBL_GRAVITY: EnumType;
  /** clamp control to specified range         */
  mjDSBL_CLAMPCTRL: EnumType;
  /** warmstart constraint solver              */
  mjDSBL_WARMSTART: EnumType;
  /** remove collisions with parent body       */
  mjDSBL_FILTERPARENT: EnumType;
  /** apply actuation forces                   */
  mjDSBL_ACTUATION: EnumType;
  /** integrator safety: make ref[0]>=2*timestep */
  mjDSBL_REFSAFE: EnumType;
  /** sensors                                  */
  mjDSBL_SENSOR: EnumType;
  /** number of disable flags                  */
  mjNDISABLE: EnumType;
}

/**  enable optional feature bitflags        */
export interface mjtEnableBit {
  /** override contact parameters              */
  mjENBL_OVERRIDE: EnumType;
  /** energy computation                       */
  mjENBL_ENERGY: EnumType;
  /** record solver statistics                 */
  mjENBL_FWDINV: EnumType;
  /** add noise to sensor data                 */
  mjENBL_SENSORNOISE: EnumType;
  /** multi-point convex collision detection   */
  mjENBL_MULTICCD: EnumType;
  /** number of enable flags                   */
  mjNENABLE: EnumType;
}

/**  type of degree of freedom               */
export interface mjtJoint {
  /** global position and orientation (quat)       (7) */
  mjJNT_FREE: EnumType;
  /** orientation (quat) relative to parent        (4) */
  mjJNT_BALL: EnumType;
  /** sliding distance along body-fixed axis       (1) */
  mjJNT_SLIDE: EnumType;
  /** rotation angle (rad) around body-fixed axis  (1) */
  mjJNT_HINGE: EnumType;
}

/**  type of geometric shape                 */
export interface mjtGeom {
  /** plane                                    */
  mjGEOM_PLANE: EnumType;
  /** height field                             */
  mjGEOM_HFIELD: EnumType;
  /** sphere                                   */
  mjGEOM_SPHERE: EnumType;
  /** capsule                                  */
  mjGEOM_CAPSULE: EnumType;
  /** ellipsoid                                */
  mjGEOM_ELLIPSOID: EnumType;
  /** cylinder                                 */
  mjGEOM_CYLINDER: EnumType;
  /** box                                      */
  mjGEOM_BOX: EnumType;
  /** mesh                                     */
  mjGEOM_MESH: EnumType;
  /** number of regular geom types             */
  mjNGEOMTYPES: EnumType;
  /** arrow                                    */
  mjGEOM_ARROW: EnumType;
  /** arrow without wedges                     */
  mjGEOM_ARROW1: EnumType;
  /** arrow in both directions                 */
  mjGEOM_ARROW2: EnumType;
  /** line                                     */
  mjGEOM_LINE: EnumType;
  /** skin                                     */
  mjGEOM_SKIN: EnumType;
  /** text label                               */
  mjGEOM_LABEL: EnumType;
  /** missing geom type                        */
  mjGEOM_NONE: EnumType;
}

/**  tracking mode for camera and light      */
export interface mjtCamLight {
  /** pos and rot fixed in body                */
  mjCAMLIGHT_FIXED: EnumType;
  /** pos tracks body: EnumType ; rot fixed in global     */
  mjCAMLIGHT_TRACK: EnumType;
  /** pos tracks subtree com: EnumType ; rot fixed in body */
  mjCAMLIGHT_TRACKCOM: EnumType;
  /** pos fixed in body: EnumType ; rot tracks target body */
  mjCAMLIGHT_TARGETBODY: EnumType;
  /** pos fixed in body: EnumType ; rot tracks target subtree com */
  mjCAMLIGHT_TARGETBODYCOM: EnumType;
}

/**  type of texture                         */
export interface mjtTexture {
  /** 2d texture: EnumType ; suitable for planes and hfields */
  mjTEXTURE_2D: EnumType;
  /** cube texture: EnumType ; suitable for all other geom types */
  mjTEXTURE_CUBE: EnumType;
  /** cube texture used as skybox              */
  mjTEXTURE_SKYBOX: EnumType;
}

/**  integrator mode                         */
export interface mjtIntegrator {
  /** semi-implicit Euler                      */
  mjINT_EULER: EnumType;
  /** 4th-order Runge Kutta                    */
  mjINT_RK4: EnumType;
  /** implicit in velocity                     */
  mjINT_IMPLICIT: EnumType;
}

/**  collision mode for selecting geom pairs */
export interface mjtCollision {
  /** test precomputed and dynamic pairs       */
  mjCOL_ALL: EnumType;
  /** test predefined pairs only               */
  mjCOL_PAIR: EnumType;
  /** test dynamic pairs only                  */
  mjCOL_DYNAMIC: EnumType;
}

/**  type of friction cone                   */
export interface mjtCone {
  /** pyramidal                                */
  mjCONE_PYRAMIDAL: EnumType;
  /** elliptic                                 */
  mjCONE_ELLIPTIC: EnumType;
}

/**  type of constraint Jacobian             */
export interface mjtJacobian {
  /** dense                                    */
  mjJAC_DENSE: EnumType;
  /** sparse                                   */
  mjJAC_SPARSE: EnumType;
  /** dense if nv<60: EnumType ; sparse otherwise         */
  mjJAC_AUTO: EnumType;
}

/**  constraint solver algorithm             */
export interface mjtSolver {
  /** PGS    (dual)                            */
  mjSOL_PGS: EnumType;
  /** CG     (primal)                          */
  mjSOL_CG: EnumType;
  /** Newton (primal)                          */
  mjSOL_NEWTON: EnumType;
}

/**  type of equality constraint             */
export interface mjtEq {
  /** connect two bodies at a point (ball joint) */
  mjEQ_CONNECT: EnumType;
  ...
  mjEQ_TENDON: EnumType;
  /** unsupported: EnumType ; will cause an error if used */
  mjEQ_DISTANCE: EnumType;
}

/**  type of tendon wrap object              */
export interface mjtWrap {
  /** null object                              */
  mjWRAP_NONE: EnumType;
  /** constant moment arm                      */
  mjWRAP_JOINT: EnumType;
  /** pulley used to split tendon              */
  mjWRAP_PULLEY: EnumType;
  /** pass through site                        */
  mjWRAP_SITE: EnumType;
  /** wrap around sphere                       */
  mjWRAP_SPHERE: EnumType;
  /** wrap around (infinite) cylinder          */
  mjWRAP_CYLINDER: EnumType;
}

/**  type of actuator transmission           */
export interface mjtTrn {
  /** force on joint                           */
  mjTRN_JOINT: EnumType;
  /** force on joint: EnumType ; expressed in parent frame */
  mjTRN_JOINTINPARENT: EnumType;
  /** force via slider-crank linkage           */
  mjTRN_SLIDERCRANK: EnumType;
  /** force on tendon                          */
  mjTRN_TENDON: EnumType;
  /** force on site                            */
  mjTRN_SITE: EnumType;
  /** adhesion force on a body's geoms         */
  mjTRN_BODY: EnumType;
  /** undefined transmission type              */
  mjTRN_UNDEFINED: EnumType;
}

/**  type of actuator dynamics               */
export interface mjtDyn {
  /** no internal dynamics; ctrl specifies force */
  mjDYN_NONE: EnumType;
  /** integrator: da/dt = u                    */
  mjDYN_INTEGRATOR: EnumType;
  /** linear filter: da/dt = (u-a) / tau       */
  mjDYN_FILTER: EnumType;
  /** piece-wise linear filter with two time constants */
  mjDYN_MUSCLE: EnumType;
  /** user-defined dynamics type               */
  mjDYN_USER: EnumType;
}

/**  type of actuator gain                   */
export interface mjtGain {
  /** fixed gain                               */
  mjGAIN_FIXED: EnumType;
  /** const + kp*length + kv*velocity          */
  mjGAIN_AFFINE: EnumType;
  /** muscle FLV curve computed by mju_muscleGain() */
  mjGAIN_MUSCLE: EnumType;
  /** user-defined gain type                   */
  mjGAIN_USER: EnumType;
}

/**  type of actuator bias                   */
export interface mjtBias {
  /** no bias                                  */
  mjBIAS_NONE: EnumType;
  /** const + kp*length + kv*velocity          */
  mjBIAS_AFFINE: EnumType;
  /** muscle passive force computed by mju_muscleBias() */
  mjBIAS_MUSCLE: EnumType;
  /** user-defined bias type                   */
  mjBIAS_USER: EnumType;
}

/**  type of MujoCo object                   */
export interface mjtObj {
  /** unknown object type                      */
  mjOBJ_UNKNOWN: EnumType;
  /** body                                     */
  mjOBJ_BODY: EnumType;
  /** body: EnumType ; used to access regular frame instead of i-frame */
  mjOBJ_XBODY: EnumType;
  /** joint                                    */
  mjOBJ_JOINT: EnumType;
  /** dof                                      */
  mjOBJ_DOF: EnumType;
  /** geom                                     */
  mjOBJ_GEOM: EnumType;
  ...
  mjOBJ_SITE: EnumType;
  /** camera                                   */
  mjOBJ_CAMERA: EnumType;
  /** light                                    */
  mjOBJ_LIGHT: EnumType;
  /** mesh                                     */
  mjOBJ_MESH: EnumType;
  /** skin                                     */
  mjOBJ_SKIN: EnumType;
  /** heightfield                              */
  mjOBJ_HFIELD: EnumType;
  /** texture                                  */
  mjOBJ_TEXTURE: EnumType;
  /** material for rendering                   */
  mjOBJ_MATERIAL: EnumType;
  /** geom pair to include                     */
  mjOBJ_PAIR: EnumType;
  /** body pair to exclude                     */
  mjOBJ_EXCLUDE: EnumType;
  /** equality constraint                      */
  mjOBJ_EQUALITY: EnumType;
  /** tendon                                   */
  mjOBJ_TENDON: EnumType;
  /** actuator                                 */
  mjOBJ_ACTUATOR: EnumType;
  /** sensor                                   */
  mjOBJ_SENSOR: EnumType;
  /** numeric                                  */
  mjOBJ_NUMERIC: EnumType;
  /** text                                     */
  mjOBJ_TEXT: EnumType;
  /** tuple                                    */
  mjOBJ_TUPLE: EnumType;
  /** keyframe                                 */
  mjOBJ_KEY: EnumType;
  /** plugin instance                          */
  mjOBJ_PLUGIN: EnumType;
}

/**  type of constraint                      */
export interface mjtConstraint {
  /** equality constraint                      */
  mjCNSTR_EQUALITY: EnumType;
  /** dof friction                             */
  mjCNSTR_FRICTION_DOF: EnumType;
  /** tendon friction                          */
  mjCNSTR_FRICTION_TENDON: EnumType;
  /** joint limit                              */
  mjCNSTR_LIMIT_JOINT: EnumType;
  /** tendon limit                             */
  mjCNSTR_LIMIT_TENDON: EnumType;
  /** frictionless contact                     */
  mjCNSTR_CONTACT_FRICTIONLESS: EnumType;
  /** frictional contact: EnumType ; pyramidal friction cone */
  mjCNSTR_CONTACT_PYRAMIDAL: EnumType;
  /** frictional contact: EnumType ; elliptic friction cone */
  mjCNSTR_CONTACT_ELLIPTIC: EnumType;
}

/**  constraint state                        */
export interface mjtConstraintState {
  /** constraint satisfied: EnumType ; zero cost (limit: EnumType ; contact) */
  mjCNSTRSTATE_SATISFIED: EnumType;
  /** quadratic cost (equality: EnumType ; friction: EnumType ; limit: EnumType ; contact) */
  mjCNSTRSTATE_QUADRATIC: EnumType;
  /** linear cost: EnumType ; negative side (friction)    */
  mjCNSTRSTATE_LINEARNEG: EnumType;
  /** linear cost: EnumType ; positive side (friction)    */
  mjCNSTRSTATE_LINEARPOS: EnumType;
  /** squared distance to cone cost (elliptic contact) */
  mjCNSTRSTATE_CONE: EnumType;
}

/**  type of sensor                          */
export interface mjtSensor {
  /** scalar contact normal forces summed over sensor zone */
  mjSENS_TOUCH: EnumType;
  /** 3D linear acceleration: EnumType ; in local frame   */
  mjSENS_ACCELEROMETER: EnumType;
  /** 3D linear velocity: EnumType ; in local frame       */
  mjSENS_VELOCIMETER: EnumType;
  /** 3D angular velocity: EnumType ; in local frame      */
  mjSENS_GYRO: EnumType;
  /** 3D force between site's body and its parent body */
  mjSENS_FORCE: EnumType;
  /** 3D torque between site's body and its parent body */
  mjSENS_TORQUE: EnumType;
  /** 3D magnetometer                          */
  mjSENS_MAGNETOMETER: EnumType;
  /** scalar distance to nearest geom or site along z-axis */
  mjSENS_RANGEFINDER: EnumType;
  /** scalar joint position (hinge and slide only) */
  mjSENS_JOINTPOS: EnumType;
  /** scalar joint velocity (hinge and slide only) */
  mjSENS_JOINTVEL: EnumType;
  /** scalar tendon position                   */
  mjSENS_TENDONPOS: EnumType;
  /** scalar tendon velocity                   */
  mjSENS_TENDONVEL: EnumType;
  /** scalar actuator position                 */
  mjSENS_ACTUATORPOS: EnumType;
  /** scalar actuator velocity                 */
  mjSENS_ACTUATORVEL: EnumType;
  /** scalar actuator force                    */
  mjSENS_ACTUATORFRC: EnumType;
  /** 4D ball joint quaternion                 */
  mjSENS_BALLQUAT: EnumType;
  /** 3D ball joint angular velocity           */
  mjSENS_BALLANGVEL: EnumType;
  /** joint limit distance-margin              */
  mjSENS_JOINTLIMITPOS: EnumType;
  /** joint limit velocity                     */
  mjSENS_JOINTLIMITVEL: EnumType;
  /** joint limit force                        */
  mjSENS_JOINTLIMITFRC: EnumType;
  /** tendon limit distance-margin             */
  mjSENS_TENDONLIMITPOS: EnumType;
  /** tendon limit velocity                    */
  mjSENS_TENDONLIMITVEL: EnumType;
  /** tendon limit force                       */
  mjSENS_TENDONLIMITFRC: EnumType;
  /** 3D position                              */
  mjSENS_FRAMEPOS: EnumType;
  /** 4D unit quaternion orientation           */
  mjSENS_FRAMEQUAT: EnumType;
  /** 3D unit vector: x-axis of object's frame */
  mjSENS_FRAMEXAXIS: EnumType;
  /** 3D unit vector: y-axis of object's frame */
  mjSENS_FRAMEYAXIS: EnumType;
  /** 3D unit vector: z-axis of object's frame */
  mjSENS_FRAMEZAXIS: EnumType;
  /** 3D linear velocity                       */
  mjSENS_FRAMELINVEL: EnumType;
  /** 3D angular velocity                      */
  mjSENS_FRAMEANGVEL: EnumType;
  /** 3D linear acceleration                   */
  mjSENS_FRAMELINACC: EnumType;
  /** 3D angular acceleration                  */
  mjSENS_FRAMEANGACC: EnumType;
  /** 3D center of mass of subtree             */
  mjSENS_SUBTREECOM: EnumType;
  /** 3D linear velocity of subtree            */
  mjSENS_SUBTREELINVEL: EnumType;
  /** 3D angular momentum of subtree           */
  mjSENS_SUBTREEANGMOM: EnumType;
  /** simulation time                          */
  mjSENS_CLOCK: EnumType;
  /** plugin-controlled                        */
  mjSENS_PLUGIN: EnumType;
  /** sensor data provided by mjcb_sensor callback */
  mjSENS_USER: EnumType;
}

/**  computation stage                       */
export interface mjtStage {
  /** no computations                          */
  mjSTAGE_NONE: EnumType;
  /** position-dependent computations          */
  mjSTAGE_POS: EnumType;
  /** velocity-dependent computations          */
  mjSTAGE_VEL: EnumType;
  /** acceleration/force-dependent computations */
  mjSTAGE_ACC: EnumType;
}

/**  data type for sensors                   */
export interface mjtDataType {
  /** real values: EnumType ; no constraints              */
  mjDATATYPE_REAL: EnumType;
  /** positive values; 0 or negative: inactive */
  mjDATATYPE_POSITIVE: EnumType;
  /** 3D unit vector                           */
  mjDATATYPE_AXIS: EnumType;
  /** unit quaternion                          */
  mjDATATYPE_QUATERNION: EnumType;
}

/**  mode for actuator length range computation */
export interface mjtLRMode {
  /** do not process any actuators             */
  mjLRMODE_NONE: EnumType;
  /** process muscle actuators                 */
  mjLRMODE_MUSCLE: EnumType;
  /** process muscle and user actuators        */
  mjLRMODE_MUSCLEUSER: EnumType;
  /** process all actuators                    */
  mjLRMODE_ALL: EnumType;
}
...
export declare interface MujocoModule extends EmscriptenModule {
  ...
  mjtDisableBit: typeof mjtDisableBit
  mjtEnableBit: typeof mjtEnableBit
  mjtJoint: typeof mjtJoint
  mjtGeom: typeof mjtGeom
  mjtCamLight: typeof mjtCamLight
  mjtTexture: typeof mjtTexture
  mjtIntegrator: typeof mjtIntegrator
  mjtCollision: typeof mjtCollision
  mjtCone: typeof mjtCone
  mjtJacobian: typeof mjtJacobian
  mjtSolver: typeof mjtSolver
  mjtEq: typeof mjtEq
  mjtWrap: typeof mjtWrap
  mjtTrn: typeof mjtTrn
  mjtDyn: typeof mjtDyn
  mjtGain: typeof mjtGain
  mjtBias: typeof mjtBias
  mjtObj: typeof mjtObj
  mjtConstraint: typeof mjtConstraint
  mjtConstraintState: typeof mjtConstraintState
  mjtSensor: typeof mjtSensor
  mjtStage: typeof mjtStage
  mjtDataType: typeof mjtDataType
  mjtLRMode: typeof mjtLRMode
}
